...
class Events extends PDX_Controller {
    ...
    {
        $this->_addedit('edit', $id);
    }

    public function _addedit($action, $event_id = null)
    {
        // Load page variables
        $vars = array(
            'page' => array(
                'css'   => array(
                    ...
                    '/assets/templates/members/css/events/addedit.css'
                ),
                'js'    => array(
                    '/assets/js/jquery.redactor.min.js',
                    '/assets/templates/members/js/events/addedit.js'
                )
            ),
            'event_types' => $this->event->getEventTypes(),
            'action' => $action
        );
        ...
        $this->load->view('templates/members/header');
        $this->load->view('templates/members/debug');
        $this->load->view('templates/members/pages/events/addedit');
        $this->load->view('templates/members/footer');
    }
